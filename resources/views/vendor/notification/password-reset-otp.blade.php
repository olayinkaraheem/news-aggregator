<x-mails.header>Password Reset OTP</x-mails.header>
<x-mails.body>
    <x-slot name="bodyTitle">
        <x-mails.body-title>Password Reset OTP</x-mails.body-title>
    </x-slot>
    <x-slot name="bodyContent">
        <x-mails.body-content>
            ...
            <x-mails.spacer />
            <x-mails.paragraph>
                To complete your password process and ensure the security of your {{env('APP_NAME')}} account, we
            ...
            <x-mails.spacer />
            <x-mails.paragraph>
                Please use this code to complete your initiated password reset.
            </x-mails.paragraph>
            <x-mails.spacer />
            <x-mails.paragraph>
